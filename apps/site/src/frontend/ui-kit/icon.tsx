...
function Svg(props: IIconProps & IChildren & { viewBox: string }) {
  return (
    <svg
      style={{ transform: `rotate(${props.rotation || 0}deg)` }}
      width={props.size || DEFAULT_SIZE}
      height={props.size || DEFAULT_SIZE}
      onClick={!props.disabled && props.onClick !== undefined ? props.onClick : undefined}
    ...
    <Switch>
      <Match when={props.kind === EIconKind.ArrowRightUp}>
        <Svg {...props} viewBox="0 0 15 15">
          <path
            ...
            stroke={props.color || COLOR_BLACK}
            stroke-width="1.7"
      ...
      <Match when={props.kind === EIconKind.ChevronUp}>
        <Svg {...props} viewBox="0 0 20 20">
          <path d="M18 14L10 6L2 14" stroke={props.color || COLOR_BLACK} stroke-width="1.2" />
        </Svg>
      </Match>
      <Match when={props.kind === EIconKind.Edit}>
        <Svg {...props} viewBox="0 0 20 22">
          <path
      ...
      <Match when={props.kind === EIconKind.Plus}>
        <Svg {...props} viewBox="0 0 20 20">
          <path d="M0 9.7902H20M10.2098 0L10.2098 20" stroke={props.color || COLOR_BLACK} />
        </Svg>
      </Match>
